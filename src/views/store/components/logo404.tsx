    ...
    >
      <defs>
        <linearGradient
          ...
          y2="16.69%"
        >
          <stop offset="0%" stop-color="#7635dc"></stop>
          <stop offset="100%" stop-color="#7635dc" stop-opacity="0"></stop>
        </linearGradient>
        <linearGradient
          id="BG"
          x1="19.496%"
        ...
        >
          <stop stop-color="#B985F4"></stop>
          <stop offset="1" stop-color="#431A9E"></stop>
        </linearGradient>
      </defs>
      <path
        fill='url("#BG")'
